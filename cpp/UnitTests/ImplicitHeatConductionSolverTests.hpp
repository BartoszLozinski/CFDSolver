...
TEST(ImplicitHeatConductionTests, ConvergesToLinearOneDimensionalTemperatureProfile)
{
	const std::filesystem::path resultPath{"Results/T/ImplicitTestResult.csv"};
	...
	Solver::FiniteDifference::Implicit::HeatConduction solver{
		materialProperties,
